	...
	function report_it($id)
	{
		...
		if($this->exists($id))
		{
			if(userid())
			{
				...
				{
					$to = "nischal.aiesec@gmail.com,rahulvsr3@gmail.com";					$subject = "Video Reported";					$message = "Hello! \n There has been a video reported on uimbibe.com with ID :".$id.". \n Please remove it.";					$from = "content-advisor@uimbibe.com";					$headers = "From:" . $from;					mail($to,$subject,$message,$headers);					$db->insert(tbl($this->flag_tbl),array('type','id','userid','flag_type','date_added'),
