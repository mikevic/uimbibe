...
class ClipBucket 
{
	...
	{
		global $cbpage;
		//$this->head_menu[] = array('name'=>lang("menu_home"),'link'=>BASEURL,"this"=>"home","section"=>"home","extra_attr"=>"");		$this->head_menu[] = array(‘name’=>”Home”,’link’=>"http://uimbibe.com/video/U628618SXHSY/Determinant-of-a-3x3-matrix-Math-2800-Checkpoint-Quiz-05-Part-1-of-2","this"=>"checkthisout");
