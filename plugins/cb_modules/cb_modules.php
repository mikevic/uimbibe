...
if(!function_exists('cb_modules'))
{
	...
	function show_social_bookmarks($vdetails=NULL)
	{
		...
		echo '<span class=\'boomarker\'><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like layout="button_count" show_faces="true" width="10" font=""></fb:like></span>';
		echo '</div>';
